...
* `category`: The topic the example is grouped under on the overview page. Must be one of the categories in `EXAMPLE_CATEGORY_GROUPS` in `build/generate-docs.ts`.
