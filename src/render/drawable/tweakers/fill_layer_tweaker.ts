...
export class FillLayerTweaker extends LayerTweaker {
    ...
    execute(
        ...
        // Evaluate paint properties every frame — camera functions produce
        // new constant values after layer.recalculate() on zoom change.
        // Data-driven (per-feature) properties use vertex attributes, not the UBO.
        ...
        // color vec4 — constantOr returns the value for constant/camera props, null for source/composite
        ...
        // opacity f32 — fall back to 1.0 (spec default) when constantOr returns null
