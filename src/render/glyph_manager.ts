...
import fontJsAsset from './font_js_asset.json';
...
export class GlyphManager {
    ...
    _tinySDF(entry: Entry, stack: string, id: number): StyleGlyph {
        ...
        char.data = newData;
        char.width = fontJsAsset[letter]['metadata']['width'];
        char.height = fontJsAsset[letter]['metadata']['height'];
        char.glyphWidth = fontJsAsset[letter]['metadata']['width'];
        char.glyphHeight = fontJsAsset[letter]['metadata']['height'];
        char.glyphLeft = fontJsAsset[letter]['metadata']['xoffset'];
        char.glyphTop = 36 - fontJsAsset[letter]['metadata']['yoffset'];
        char.glyphAdvance = fontJsAsset[letter]['metadata']['xadvance'];
