...
import {TerrainRenderManager} from '../tile/terrain_render_manager';
 ...
 *
 * 1. loads raster-dem tiles via the internal renderManager
 ...
 * 4. stores all render-to-texture tiles in the renderManager
...
export class Terrain {
     ...
     */
    renderManager: TerrainRenderManager;
    /**
    ...
    constructor(painter: Painter, tileManager: TileManager, options: TerrainSpecification) {
        ...
        this.renderManager = new TerrainRenderManager(tileManager);
    ...
    getTerrainData(tileID: OverscaledTileID): TerrainData {
        ...
        const sourceTile = this.renderManager.getSourceTile(tileID, true);
        ...
        if (matrixKey && !this._demMatrixCache[matrixKey]) {
            const maxzoom = this.renderManager.getSource().maxzoom;
    ...
    pointCoordinate(p: Point): MercatorCoordinate {
        ...
        const tile = tileID && this.renderManager.getTileByID(tileID);
