...
class Map extends Camera {
    ...
    */
     ...
     * @param options.contentMatch Optional enum value (or `none`) that may match the content's `height` or `width` and limit the other dimension from getting smaller than the aspect ratio of content.
