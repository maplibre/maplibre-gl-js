 ...
 * @param {boolean} [options.refreshExpiredTiles=true] If `false`, the map won't attempt to re-request tiles once they expire per their HTTP `cacheControl`/`expires` headers. Override this property for individual vector/raster/raster-dom sources. (See [sources refreshExpiredTiles property](https://maplibre.org/maplibre-gl-js-docs/style-spec/sources))
