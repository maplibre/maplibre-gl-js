...
export class Map extends Camera {
    ...
    _render(paintStartTimeStamp: number) {
        ...
        const initialGlobeControls = this.transform.useGlobeControls;
        ...
        this.transform.setGlobeness(this.style.projection.transitionState);
        // HM TODO: solve this
        ...
        if (this.style && (this._sourcesDirty || initialGlobeControls !== this.transform.useGlobeControls)) {
        ...
        this._placementDirty = this.style && this.style._updatePlacement(this.transform, this.showCollisionBoxes, fadeDuration, this._crossSourceCollisions, initialGlobeControls !== this.transform.useGlobeControls);
