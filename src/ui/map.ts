import type {Complete, Subscription} from '../util/util';
...
import type {AddLayerObject, FeatureIdentifier, StyleOptions, StyleSetterOptions, StyleSwapOptions} from '../style/style';
import type {MapDataEvent,MapEventType, MapLayerEventType, MapSourceDataEvent, MapStyleDataEvent} from './events';
import type {StyleImage, StyleImageInterface, StyleImageMetadata} from '../style/style_image';
import type {PointLike, CameraOptions, CameraUpdateTransformFunction, FitBoundsOptions} from './camera';
