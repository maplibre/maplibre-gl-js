...
export const generateOneFingerTouchRotationHandler = ({clickTolerance, bearingDegreesPerPixelMoved = 0.8}: {
...
export const generateOneFingerTouchPitchHandler = ({clickTolerance, pitchDegreesPerPixelMoved = -0.5}: {
    clickTolerance: number;
