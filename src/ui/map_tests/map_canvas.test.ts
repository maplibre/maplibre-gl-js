...
describe('Max Canvas Size option', () => {
    test('maxCanvasSize width = height', () => {
        ...
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferWidth', 'get').mockReturnValue(8192);
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferHeight', 'get').mockReturnValue(8192);
    ...
    test('maxCanvasSize width != height', () => {
        ...
        Object.defineProperty(container, 'clientHeight', {value: 2048});
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferWidth', 'get').mockReturnValue(8192);
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferHeight', 'get').mockReturnValue(4096);
    ...
    test('maxCanvasSize below clientWidth and clientHeight', () => {
        ...
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferWidth', 'get').mockReturnValue(4096);
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferHeight', 'get').mockReturnValue(8192);
    ...
    test('maxCanvasSize with setPixelRatio', () => {
        ...
        Object.defineProperty(container, 'clientWidth', {value: 2048});
        Object.defineProperty(container, 'clientHeight', {value: 2048});
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferWidth', 'get').mockReturnValue(3072);
        vi.spyOn(WebGL2RenderingContext.prototype, 'drawingBufferHeight', 'get').mockReturnValue(3072);
