...
vec4 projectTile(vec2 posInTile) {
    ...
    // and projecting them with spherical mercator. This means that the spherical computed below are actually wgs84 coordinates!
...
#else
#define projectTile(p) (vec4((p).x, (p).y, 0.0, 1.0))
#endif
