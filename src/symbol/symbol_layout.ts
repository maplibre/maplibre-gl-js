...
function addFeature(bucket: SymbolBucket,
    ...
    const glyphSize = 24,
        ...
        iconRotatesWithMap = bucket.layers[0].hasDataDrivenIconRotationAlignment &&
            bucket.layers[0].iconRotatesWithMap(feature, canonical),
    ...
    const addSymbolAtAnchor = (line, anchor) => {
        ...
        addSymbol(bucket, anchor, line, shapedTextOrientations, shapedIcon, imageMap, verticallyShapedIcon, bucket.layers[0],
            ...
            iconBoxScale, iconPadding, iconRotatesWithMap, iconOffset,
