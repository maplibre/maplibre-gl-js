...
test('shapeIcon', (t) => {
    ...
    t.test('text-anchor: center', (t) => {
        ...
        expect(shaping.shapeIcon(imagePosition, [ 4, 7 ], 'center')).toEqual({
            top: -3,
            bottom: 17,
            left: -6,
            right: 14,
    ...
    t.test('text-anchor: left', (t) => {
        ...
        expect(shaping.shapeIcon(imagePosition, [ 4, 7 ], 'left')).toEqual({
            top: -3,
            bottom: 17,
            left: 4,
            right: 24,
    ...
    t.test('text-anchor: bottom-right', (t) => {
        ...
        expect(shaping.shapeIcon(imagePosition, [ 4, 7 ], 'bottom-right')).toEqual({
            top: -13,
            bottom: 7,
            left: -16,
            right: 4,
