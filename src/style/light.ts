import {interpolates, Color, latest as styleSpec} from '@acalcutt/maplibre-gl-style-spec';
...
import type {StylePropertySpecification, LightSpecification} from '@acalcutt/maplibre-gl-style-spec';
