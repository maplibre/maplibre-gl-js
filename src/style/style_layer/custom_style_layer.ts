...
export type CustomRenderMethodInput = {
    ...
    */
     ...
     * Use `map._camera.transform.getProjectionData({overscaledTileID: tileID})` to get uniforms for a given tile and pass vec2 in tile-local range 0..EXTENT instead.
     *
