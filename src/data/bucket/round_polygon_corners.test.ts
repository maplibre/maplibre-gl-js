...
describe('roundPolygonCorners', () => {
    ...
    test('clamps corner rounding distance to half edge length when requested distance is large', () => {
        const input = [[
            new Point(0, 0),
            new Point(10, 0),
            new Point(10, 10),
    ...
    test('preserves colinear 180-degree vertices without adding arc points', () => {
        const input = [[
            new Point(0, 0),
            new Point(50, 0),
            new Point(100, 0),
