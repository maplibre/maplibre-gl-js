...
import {FeatureTable, filter, Point, GeometryVector, SelectionVector} from "@maplibre/mlt";
 ...
 * Line bucket class
 */
export class OptimizedColumnarLineBucket implements Bucket {
    distance: number;
...
register('OptimizedColumnarLineBucket', OptimizedColumnarLineBucket, {omit: ['layers', 'patternFeatures']});
