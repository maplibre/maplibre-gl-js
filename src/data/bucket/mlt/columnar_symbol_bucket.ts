...
import {FeatureTable, filter, GeometryVector, SelectionVector} from "@maplibre/mlt";
...
export class ColumnarSymbolBucket implements Bucket {
    ...
    populateColumnar(featureTable: FeatureTable, options: PopulateParameters, canonical: CanonicalTileID) {
        ...
        if(topologyVector.partOffsets != null || topologyVector.ringOffsets!= null){
            throw new Error("Currently only point geometries are supported for Symbols");
        }
        ...
        for(let i = 0; i < selectionVector.limit; i++){
            ...
            if(topologyVector.geometryOffsets){
                ...
                for(let i = 0; i < numPoints; i++){
                    ...
                    points.push(new Point(vertex[0], vertex[1]));
                }
            }
            else{
