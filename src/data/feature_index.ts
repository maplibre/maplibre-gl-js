...
import {featureFilter} from '@acalcutt/maplibre-gl-style-spec';
...
import type {FeatureFilter, FeatureState, FilterSpecification, PromoteIdSpecification} from '@acalcutt/maplibre-gl-style-spec';
