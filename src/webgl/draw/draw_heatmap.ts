...
import {prepareHeatmapWebGPU, compositeHeatmapWebGPU} from '../../webgpu/draw/draw_heatmap_webgpu.ts';
...
function prepareHeatmapTerrain(painter: Painter, tile: Tile, layer: HeatmapStyleLayer, coord: OverscaledTileID, isRenderingGlobe: boolean) {
    ...
    program.draw(context, gl.TRIANGLES, DepthMode.disabled, stencilMode, colorMode, CullFaceMode.disabled,
        heatmapUniformValues(tile, painter.transform.zoom, layer.paint.get('heatmap-intensity'), 1.0) as any, terrainData, projectionData,
        layer.id, bucket.layoutVertexBuffer, bucket.indexBuffer,
