...
interface ITransformMutators {
     ...
     * @param keepBearingFixed - Whether the bearing should be kept fixed for globe transform.
     */
    setLocationAtPoint(lnglat: LngLat, point: Point, keepBearingFixed?: boolean): void;
