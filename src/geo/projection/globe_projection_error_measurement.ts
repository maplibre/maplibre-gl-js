...
import {projectionErrorMeasurementUniformValues} from '../../webgl/program/projection_error_measurement_program.ts';
...
import {type ProjectionGPUContext} from './projection.ts';
