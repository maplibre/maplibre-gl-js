...
import ValidationError from '@maplibre/maplibre-gl-style-spec/tsc/src/error/validation_error';

import type Map from '../ui/map';
import type Dispatcher from '../util/dispatcher';
import type {Evented} from '../util/evented';
import type {VideoSourceSpecification} from '@maplibre/maplibre-gl-style-spec/dist';
