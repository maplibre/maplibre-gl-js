...
- Fix globe panning inverting and stalling near the poles: in the polar region the globe is rotated with a quaternion (which may change bearing), while the bearing-preserving drag is kept everywhere else ([#5296](https://github.com/maplibre/maplibre-gl-js/issues/5296)) (by [@jcolot](https://github.com/jcolot))
- _...Add new stuff here..._
