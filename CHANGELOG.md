...
- Keep `line-dasharray` spacing correct when `line-offset` is also set ([#7671](https://github.com/maplibre/maplibre-gl-js/issues/7671)) (by [@dyk1454683243-sudo](https://github.com/dyk1454683243-sudo))
- _...Add new stuff here..._
