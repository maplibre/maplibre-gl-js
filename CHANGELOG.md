...
- Fix `map.remove()` directly after creation because async style load via URL accessing `projection` on the destroyed style ([#7368](https://github.com/maplibre/maplibre-gl-js/pull/7368)) (by [@CommanderStorm](https://github.com/CommanderStorm))
