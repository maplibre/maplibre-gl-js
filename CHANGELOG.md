...
- Fix Map freeze when `Camera.easeTo` is called at any movement event (move, zoom, rotate, pitch) from another `Camera.easeTo` call ([#3853](https://github.com/maplibre/maplibre-gl-js/pull/3853))
