...
- Add `Map#setMissingStyleImageResolver` for resolving missing style images with sync or async callbacks. Images added from `styleimagemissing` listeners no longer resolve the current image request ([#7850](https://github.com/maplibre/maplibre-gl-js/pull/7850)) (by [@birkskyum](https://github.com/birkskyum))
