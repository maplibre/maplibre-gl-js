...
### 🐞 Bug fixes
- Preserve `font-faces` glyphs when loading PBF ranges and share concurrent glyph requests. ([#8490](https://github.com/maplibre/maplibre-gl-js/pull/8490)) (by [@NEKOYASAN](https://github.com/NEKOYASAN))
