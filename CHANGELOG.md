...
- ⚠️ Update maplibre-gl-style-spec to version 25, which now throws an error with warning severity instead of sliently failing ([#7792](https://github.com/maplibre/maplibre-gl-js/issues/7792)) (by [@HarelM](https://github.com/HarelM))
