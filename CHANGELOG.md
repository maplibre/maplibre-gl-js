...
- Fix markers and popups sitting a few pixels off the terrain after a drag on the globe, and after a move into terrain that is still loading ([#6584](https://github.com/maplibre/maplibre-gl-js/issues/6584)) (by [@patte](https://github.com/patte))
