...
- _...Add new stuff here..._
- Fix `style.load` event not being fired when a new JSON style spec is diffed. [#6880](https://github.com/maplibre/maplibre-gl-js/pull/6880) (by [lesbaa](https://githib.com/lesbaa))
