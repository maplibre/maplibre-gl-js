...
### 🐞 Bug fixes
- Fix terrain keeping stale drape textures after a zoom animation: draped layers (lines, fills, rasters) stayed rendered at a mid-animation zoom — wrong widths, densities and other zoom-dependent styling — until an unrelated repaint happened to re-render the tile ([#8250](https://github.com/maplibre/maplibre-gl-js/pull/8250))
