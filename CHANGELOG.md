...
- Fix 3D terrain sampling DEM pixels at tile corners while hillshade and color-relief sample them at cell centres, which offset draped shading from the terrain by half a DEM cell ([#8411](https://github.com/maplibre/maplibre-gl-js/issues/8411)) (by [@ArcSolver](https://github.com/ArcSolver))
- Fix symbols and markers showing through 3D terrain when a DEM tile loads after the terrain depth buffer was drawn ([#8420](https://github.com/maplibre/maplibre-gl-js/pull/8420)) (by [@ArcSolver](https://github.com/ArcSolver))
