...
- Upload the projection uniform block once per tile per frame and rebind it for the rest of the draws, instead of rewriting it before every draw call ([#8474](https://github.com/maplibre/maplibre-gl-js/pull/8474)) (by [@cherenkov](https://github.com/cherenkov))
