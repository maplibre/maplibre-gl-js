...
### 🐞 Bug fixes
- Fix partially blank maps in older Safari versions by refreshing uniform buffer bindings when their data changes ([#8427](https://github.com/maplibre/maplibre-gl-js/issues/8427)).
