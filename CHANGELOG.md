...
- refactor: remove line-opacity change and refactor the code to be able to more easily accomodate layer-opacity ([#7764](https://github.com/maplibre/maplibre-gl-js/pull/7764)) (by [@CommanderStorm](https://github.com/CommanderStorm))
- Add missing changelog ([#7762](https://github.com/maplibre/maplibre-gl-js/pull/7762)) (by [@HarelM](https://github.com/HarelM))
## 6.0.0-14
### ✨ Features and improvements
- Revert the `line-opacity`-driven offscreen rendering introduced in [#7490](https://github.com/maplibre/maplibre-gl-js/pull/7490).
