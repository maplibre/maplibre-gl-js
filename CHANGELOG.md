...
- Speed up terrain raycasts (`unproject`, `queryTerrainElevation`) by keying the terrain coverage index by number instead of string and reusing the previous sample's tile ([#XXXX](https://github.com/maplibre/maplibre-gl-js/pull/XXXX)) (by [@Jua004](https://github.com/Jua004))
