...
- ESM bundle (`maplibre-gl.mjs`) with `maplibre-gl/css` and `maplibre-gl/worker` package subpaths and a `workerUrl` Map option. ([#6254](https://github.com/maplibre/maplibre-gl-js/pull/6254))
