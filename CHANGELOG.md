...
- Use HTMLImageElement to download raster source images when refreshExpiredTiles tiles is false ([#2126](https://github.com/maplibre/maplibre-gl-js/pull/2126))
- Allow overriding maps options.refreshExpiredTiles for individual vector/raster/raster-dom sources ([#2126](https://github.com/maplibre/maplibre-gl-js/pull/2126))
- *...Add new stuff here...*
