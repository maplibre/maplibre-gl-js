...
- Revert fix for zoom jump on corrupted DEM data ([#6996](https://github.com/maplibre/maplibre-gl-js/pull/6996)) (by [pstaszek](https://github.com/pstaszek))
- Fix marker positions not updating when zoom or pitch are changed following a change in constraints ([#6926](https://github.com/maplibre/maplibre-gl-js/pull/6926)) (by [Auspicus](https://github.com/Auspicus))
- improvement: handle terrarium terrain no data ([#6982](https://github.com/maplibre/maplibre-gl-js/pull/6982)) (by [pstaszek](https://github.com/pstaszek))
- typings fix for  Discussions #5463 ([#6966](https://github.com/maplibre/maplibre-gl-js/pull/6966)) (by [ricardovg4](https://github.com/ricardovg4))
## 5.17.0
### ✨ Features and improvements
