...
- Make default draggable markers keyboard focusable and movable by one screen pixel with unmodified arrow keys; custom marker focusability and keyboard behavior remain application-owned ([#8020](https://github.com/maplibre/maplibre-gl-js/issues/8020)) (by [@hugosmoreira](https://github.com/hugosmoreira))
