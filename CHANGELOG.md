...
- Improve test coverage for attribution_control.ts ([#7120](https://github.com/maplibre/maplibre-gl-js/pull/7120)) (by [pierreeurope](https://github.com/pierreeurope))
...
- Improve test coverage for scale_control.ts ([#7121](https://github.com/maplibre/maplibre-gl-js/pull/7121)) (by [pierreeurope](https://github.com/pierreeurope))
- refactor: replace deprecated substr() with startsWith() ([#7114](https://github.com/maplibre/maplibre-gl-js/pull/7114)) (by [pierreeurope](https://github.com/pierreeurope))
