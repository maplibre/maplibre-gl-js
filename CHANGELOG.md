...
- Support the style specification's `font-faces` property, with `map.setFontFaces` and `map.getFontFaces` ([#6637](https://github.com/maplibre/maplibre-gl-js/issues/6637))
- Lay text out in grapheme clusters, so complex script languages such as Devanagari, Khmer, Burmese and Hebrew render as written ([#6637](https://github.com/maplibre/maplibre-gl-js/issues/6637))
