...
- ⚠️ Changed cooperative gesture config and removed the string for it in favor of the locale variabl., Also changed the terrain enable disable locale key to match the other keys' styles ([#3621](https://github.com/maplibre/maplibre-gl-js/issues/3621))
