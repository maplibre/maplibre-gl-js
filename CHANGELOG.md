...
### 🐞 Bug fixes
- Fix transparent, overlapping lines creating weird artefacts ([#7490](https://github.com/maplibre/maplibre-gl-js/pull/7490)) (by [@CommanderStorm](https://github.com/CommanderStorm))
