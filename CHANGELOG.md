...
- Add Etag support to the coming vector/geojson worker refactor ([#7074](https://github.com/maplibre/maplibre-gl-js/pull/7074)) (by [@wayofthefuture](https://github.com/wayofthefuture))
