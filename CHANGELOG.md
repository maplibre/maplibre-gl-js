...
- Fix a `line-pattern` driven by a zoom expression rendering as an unpatterned line at some zoom levels, because only one of the two crossfading sprites was present in the atlas ([#4787](https://github.com/maplibre/maplibre-gl-js/issues/4787)) (by [@SomSamantray](https://github.com/SomSamantray))
- _...Add new stuff here..._
