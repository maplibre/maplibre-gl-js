...
- Change the pathway for passing `global-state` object from `Style` to expression to fix a hack that was intorduced in previous versions ([#6366](https://github.com/maplibre/maplibre-gl-js/pull/6366))
