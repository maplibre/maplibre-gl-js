...
## Writing Unit Tests
 ...
 - **You should only test the return values and global side effects of methods.** You should not test internal behavior, such as that another method is called with particular arguments. This ensures that method implementations may change without causing test failures.
